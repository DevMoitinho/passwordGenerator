...
link to the website: https://password-generator-flame-delta.vercel.app/

## Password Modifiers

The password generation can easily be modified to create a password that fits the users requirements. There are 4 modifications available:

### Length
Determines the quantity of characters in the password;
### Uppers
Determines if the password must contain upper letters;
### Digits
